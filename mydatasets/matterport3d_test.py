...
class Matterport3D(data.Dataset):
    ...
    def __init__(self, root_dir, list_file, equi_info, height=256, width=512, max_depth_meters=32,
        ...
        self.depth_Up_list = read_list(os.path.join(list_file, 'Matterport3D_Test_Up_depth.txt'))
        self.normal_Up_list = read_list(os.path.join(list_file, 'Matterport3D_Test_Up_rgb.txt'))
        self.depth_Center_list = read_list(os.path.join(list_file, 'Matterport3D_Test_Center_depth.txt'))
        self.normal_Center_list = read_list(os.path.join(list_file, 'Matterport3D_Test_Center_rgb.txt'))
        self.w = width
        self.h = height
    ...
    def __getitem__(self, idx):
        ...
        inputs["name"] = str(self.normal_Up_list[idx][0])
